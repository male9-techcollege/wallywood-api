...
export const getRecordsByMariePierreLessard = async (req, res) => {
    try {
        ...
        console.error(error);
        res.status(500).send(`Fejl 500: kunne ikke hente liste af kategorier fra databasen.`);
    }
    ;
};
export const getRecordByMariePierreLessard = async (req, res) => {
    ...
    try {
        ...
        console.error(error);
        res.status(500).json({ error: "Fejl 500: kunne ikke hente kategori fra databasen." });
    }
};
...
export const deleteRecordByMariePierreLessard = async (req, res) => {
    ...
    try {
        ...
        console.error(error);
        res.status(500).json({ error: "Fejl 500: kunne ikke slette kategorien i databasen." });
    }
    ;
};
