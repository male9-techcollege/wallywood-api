/* TO DO: review comments (done), rename function expressions (done), model name (done) and fields */
/* TO DO: is the composite index causing the error x3 with the id? Does a composite index need to have the type array, not number? */
/* TO DO: This used to be cfrelController. Test */
